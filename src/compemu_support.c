...
void build_comp (void)
{
    ...
    int count;
#ifdef NOFLAGS_SUPPORT
    struct cputbl *nfctbl = (currprefs.cpu_model >= 68040 ? op_smalltbl_0_nf
			   : currprefs.cpu_model == 68030 ? op_smalltbl_1_nf
			   : currprefs.cpu_model == 68020 ? op_smalltbl_2_nf
			   : currprefs.cpu_model == 68010 ? op_smalltbl_3_nf
# ifdef CPUEMU_5
